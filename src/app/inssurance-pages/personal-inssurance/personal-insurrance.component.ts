...
export class PersonalInsurranceComponent implements OnInit {
    ...
    getLangAndData() {
      ...
      this.languageService.currentLanguage$.subscribe(language => {
        ...
        this.personalService.getPersonalContent(this.currentLanguage, 'individual')
        .pipe(
          map((res: any) => {
    ...
    saveContent(subCategory: string, itemId: number) {
      ...
      this.personalService.updatePersonalContent(this.currentLanguage, 'individual', subCategory, cContentToStr)
        .subscribe(response => {
          this.isLoading = false;
